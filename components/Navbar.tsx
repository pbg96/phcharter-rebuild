      ...
      <div className="max-w-[1200px] mx-auto px-4 flex items-center h-16">
            ...
            link.children ? (
              ...
              >
                ...
                {openDropdown === link.label && (
                  <div className="absolute top-full left-0 bg-white shadow-xl rounded-b min-w-[200px] py-1 z-50 border-t-2 border-[#D0902F]">
        ...
        <div className="hidden lg:flex items-center gap-4 shrink-0">
          ...
          <a
            ...
            className="bg-[#E8B13B] text-gray-900 font-semibold text-sm px-5 py-2 rounded-full hover:bg-[#0C0297] hover:text-white transition-colors"
          >
            Enroll Now
          </a>
        </div>
        ...
        <button
          ...
          className="lg:hidden ml-auto p-2 rounded text-gray-900 hover:bg-gray-100 transition-colors"
        ...
        <div className="lg:hidden bg-white border-t border-gray-200 max-h-[80vh] overflow-y-auto shadow-lg">
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block text-center bg-[#E8B13B] text-gray-900 font-semibold text-sm px-5 py-3 rounded-full hover:bg-[#0C0297] hover:text-white transition-colors"
              onClick={() => setMobileOpen(false)}
            >
              Enroll Now
            </a>
